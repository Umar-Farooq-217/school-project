    ...
    <div>
      <div className="background">
        ...
        <div className="md:px-24 sm:px-6">
          <p className="text-sm text-white font-thin pt-20 animate__animated animate-">MOTTO</p>
      ...
      <div className=" grid md:grid-cols-2 sm:grid-cols-1 gap-20 pt-14  md:px-24 sm:px-10 mb-16">
        ...
        <div className=" mt-5 relative sm:top-0 md:top-0  left-0">
...
fasilitas yang terdapat disekolah kami kami akan ...
      ...
      <div className="md:px-24 sm:px-10">
        ...
        <div className="grid md:grid-cols-3 gap-10 mt-5 sm:grid-cols-1">
          <Image src='/Mask Group-1.png' className='w-full hover:scale-105 ' width={200} height={200}/>
          <Image src='/Mask Group-2.png' className='w-full hover:scale-105 ' width={200} height={200}/>
          <Image src='/Mask Group-3.png' className='w-full hover:scale-105' width={200} height={200}/>
          <Image src='/Mask Group.png' className='w-full hover:scale-105' width={200} height={200}/>
          <Image src='/Rectangle 7.png' className='w-full hover:scale-105' width={200} height={200}/>
          <Image src='/Rectangle 8.png' className='w-full hover:scale-105 ' width={200} height={200}/>
        </div>
      </div>
      <Footer/>
